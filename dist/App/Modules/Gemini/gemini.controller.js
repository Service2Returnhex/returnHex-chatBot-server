...
const getResponse = (0, cathcAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const result = yield gemini_service_1.GeminiService.getResponseDM("Dummy-Sender-ID", "dummy-shop", (_a = req.body) === null || _a === void 0 ? void 0 : _a.message);
